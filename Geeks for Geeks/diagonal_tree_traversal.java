/**
 * ~/Documents/Drive-E/GitHub/Competitive-Coding/Geeks for Geeks/diagonal_tree_traversal.java
...
class Tree {
    ...
    static void traverse(ArrayList<Integer> a, Node root, Queue<Node> q) {
        if (root == null) {
            return;
        }
        a.add(root.data);
        ...
        traverse(a, root.right, q);

        if (!q.isEmpty()) {
            traverse(a, q.remove(), q);
        }
    }
}
